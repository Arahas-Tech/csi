...
import increase_pop from "./assets/increase-pop.png";
import land_use from "./assets/land-use.png";
import road from "./assets/intersection.png";
import traffic from "./assets/traffic-jam.png";
import accident from "./assets/accident.png";
import peak_time from "./assets/future.png";
import tourist from "./assets/traveler.png";
    ...
    <>
      ...
      <main id="main" className="main">
        <section className="dashboard-section">
          <div className="flex align-items-start justify-conten-start flex-row row">
            <div className="col-9">
