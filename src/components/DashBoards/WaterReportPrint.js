...
import RainRecommendations from "./Recommendations/RainRecommendations";
import WaterDashboard from "./WaterDashboard";
import WaterRecommendations from "./Recommendations/WaterRecommendations";

export default function WaterReportPrint({ visible, toggleModalVisibility }) {
  ...
  const handleExport = async () => {
    if (contentRef.current) {
      ...
      pdf.save("water_summary_report.pdf");
    }
  };
